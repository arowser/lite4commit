class UsersController < ApplicationController
  ...
  def update
    if @user.update_attributes(users_params)
      ...
      render :show, alert: 'Error updating litecoin address'
    end
  end
  ...
  def login
    ...
    if @user
      ...
      if params[:unsubscribe]
        ...
        flash[:alert] = 'You unsubscribed! Sorry for bothering you. Although, you still can leave us your litecoin address to get your tips.'
      end
    else
